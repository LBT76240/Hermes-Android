 ...
 */
    ...
    public void initThread(String ip) {
        this.ip=ip;
    }
    ...
    public void runThread() {
        try {
            ...
            if (toRecv != null) {
                ...
                final String toRecvThread = toRecv;
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        //code exécuté par l'UI thread
                        txtSpeechOutput.setText(toRecvThread);
                    }
                });
            }
            //Fermeture socket
    ...
    private synchronized void send(String toSend)
    {
        ...
        try {
            ...
            if(lastJson == null) {
                ...
                jsonObj.put("type", "confirmation");
                jsonObj.put("msg",lastJson.getString("originalRequest"));
                jsonObj.put("answer",toSend);
                lastJson = null;
            }
